  ...
  <div class="min-h-screen flex">
   ...
   <div class="bg-gray-800 text-white w-64 space-y-6 py-7 px-2 fixed h-full">
    <div class="text-center">
     <img alt="Admin profile picture" class="w-24 h-24 mx-auto rounded-full" height="100" src="https://storage.googleapis.com/a1aa/image/OcOvEpS9jQxsr6Kv5cs9D0zZVgWHmjP5gK1VE12Yhkc.jpg" width="100"/>
   ...
   <div class="flex-1 p-10 ml-64">
    ...
    <div class="bg-white shadow-md rounded my-6 p-6">
     ...
     <form action="add_photographer.php" enctype="multipart/form-data" id="addPhotographerForm" method="post">
      ...
      <div class="mb-4">
       <label class="block text-gray-700 text-sm font-bold mb-2" for="photographer_experience">
        Photographer Experience (in years):
       </label>
       <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="photographer_experience" min="0" name="photographer_experience" required="" type="number"/>
      </div>
      <div class="flex items-center justify-between">
